    ...
    <main>
        <div class="mainWrapper">
            <div class="mainContainer">
                <h1 class="formTitle">Buy Stocks</h1>
                <h2 class="formSub">Enter expenses details</h2>
                <br>
                <form action="../../includes/control/handleBuy.php" method="POST">
                    <input type="link" placeholder="Item Name" name="itemName">
                    <br>
